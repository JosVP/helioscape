...
Earth vignette arc: various states per inspectable location (city skyline, coastline, forest/farmland). Each evolves independently based on tech nodes completed.
